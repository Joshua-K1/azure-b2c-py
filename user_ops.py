...
class User:
    ...
    def __init__(self, id, email, userPrin, signIn):
        self.id = id
        self.email = email
        self.userPrin = userPrin
        self.signIn = signIn

# List all users within the tenant
    def list_all(self ,args: argparse.Namespace) -> None:
           ...
           # Add continuation_url if it has changed whilst in the loop 
            ...
            for user_principle_name in user_principle_name_arr:
                ...
                # if user_identify object is less than 1
                    ...
                    user_identity_a = user_identity[0]
                    f_user_identity_a_s = user_identity_a["issuerAssignedId"]
                    f_user_identity_b_s = 'None'

                user_info = User(f_user_id, f_user_identity_a_s, f_user_identity_b_s, f_user_sign_in)
